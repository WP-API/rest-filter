 ...
 * @subpackage Wp_Rest_Filter/admin
 */
...
class Wp_Rest_Filter_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style($this->plugin_name, plugin_dir_url(__FILE__) . 'css/wp-rest-filter-admin.css', array(), $this->version, 'all');
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script($this->plugin_name, plugin_dir_url(__FILE__) . 'js/wp-rest-filter-admin.js', array('jquery'), $this->version, false);
